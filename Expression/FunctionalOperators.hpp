...
template<template<typename> class D1,typename V1, template<typename> class D2,typename V2>
constexpr decltype(auto) operator+(const UnaryFunctional<D1,V1>& f1, const UnaryFunctional<D2,V2>& f2) { return Func<Add>(f1,f2); }
...
template<template<typename> class D1,typename V1, template<typename> class D2,typename V2>
constexpr decltype(auto) operator-(const UnaryFunctional<D1,V1>& f1, const UnaryFunctional<D2,V2>& f2) { return Func<Sub>(f1,f2); }
...
template<template<typename> class D1,typename V1, template<typename> class D2,typename V2>
constexpr decltype(auto) operator*(const UnaryFunctional<D1,V1>& f1, const UnaryFunctional<D2,V2>& f2) { return Func<Mul>(f1,f2); }
...
template<template<typename> class D1,typename V1, template<typename> class D2,typename V2>
constexpr decltype(auto) operator/(const UnaryFunctional<D1,V1>& f1, const UnaryFunctional<D2,V2>& f2) { return Func<Div>(f1,f2); }
