...
namespace CSV
{
	...
	struct Repository
	{
		...
		using Parsers = Typelist<InputManager<Counter>,CEHouse, CEHall,CVat,CG1,CWA,CWO,CWOut, CBCW,CBHW, CMCW,CMHW,CTCW,CTHW, Bank::Raiffeisenbank<Configuration::Raiffeisenbank>, StageContainerType>::Type;
