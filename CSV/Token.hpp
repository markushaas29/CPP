...
{	
	inline static constexpr const char* Pattern = "(Verwendungszweck|Buchungstext)";
	inline static constexpr const char* Identifier = "VerwendungszweckIndexToken"; 
};
