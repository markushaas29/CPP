...
private:
	...
	virtual typename Base::QuantityType calc() const
	{
        ...
        auto stageIndexTokens = (*tokenFactory)({{"NameIndexToken"},{"StageIndexToken"},{"WasteIndexToken"},{"HeatingIndexToken"},{"CleaningIndexToken"},{"SewageIndexToken"},{"PropertyTaxIndexToken"},{"InsuranceIndexToken"},{"RetIndexToken"},{"ExtraCostsIndexToken"},{"HeatExtraCostsIndexToken"} });
