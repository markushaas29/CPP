...
using Bottom_HWaterDesc = CounterDescription<WaterEntity,Bottom,15018324>;
using Bottom_CWaterDesc = CounterDescription<WaterEntity,Bottom,15007241>;
using Middle_HWaterDesc = CounterDescription<WaterEntity,Middle,23267492>;
using Middle_CWaterDesc = CounterDescription<WaterEntity,Middle,14524889>;
using Top_CWaterDesc = CounterDescription<WaterEntity,Top,25489823>;
