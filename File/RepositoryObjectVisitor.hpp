...
namespace FS
{
	...
	class RepositoryObjectVisitor
	{
		...
		using OsFuncType = std::function<void(std::ostream&)>;
	...
	public:
		...
		RepositoryObjectVisitor(const std::string& n, const std::string& i,ParseFuncType p, GetFuncType g, UpdateFuncType u = [](Iterator b, Iterator e){ return true; }, OsFuncType of = [](std::ostream& os) { } ): name{n}, identifier{i},parse{p}, get{g}, update{u}, os{of}{};
		...
		void Print(std::ostream& s) { this->os(s); }
