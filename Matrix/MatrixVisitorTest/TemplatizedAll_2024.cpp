...
class TemplatizedAll_Test2024
{
	public:
		int Run()
		{
//			std::cout<<"START TemplatizedAll_ 2024"<<std::endl;
...
//			auto ibq = (*invM)(hb);
//			
//			auto invT = std::make_unique<Invoice<Top>>(tokenFactory,elementFactory,visitorFactory,Year{2024},path);
//			std::cout<<"END 2024"<<invT->Prop()<<std::endl;
...
//			auto itq = (*invT)(hb);
//			std::cout<<"END 2024"<<itq<<std::endl;
//
