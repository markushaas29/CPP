...
namespace FS
{
	...
	class RepositoryObjectVisitor
	{
		...
		using OsFuncType = std::function<OutType()>;
	...
	public:
		...
		RepositoryObjectVisitor(const std::string& n, const std::string& i,ParseFuncType p, GetFuncType g, UpdateFuncType u = [](Iterator b, Iterator e){ return true; }, OsFuncType of = []() { return OutType(); } ): name{n}, identifier{i},parse{p}, get{g}, update{u}, os{of}{};
